...
### Introduction
Очень интересный кейс на стыке Pandas + базовый Python.  
...
В столбцы из пункта 5 нужно записать найденные для данной строки значения  
